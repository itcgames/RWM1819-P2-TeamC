...
class BoundaryRect{
    ...
    */
    constructor(x, y, vertical, world, assetManager)
    {
        ...
        if(vertical)
        {
            ...
            this.image = assetManager.find(assetManager.ImageAssets, "boundary_vertical");
            this.image.setPos(x - 5, y - 450);
        } 
        else
        {
            this.body = b2dCreateBox(x, y, 800, 5, world, true);  
            this.image = assetManager.find(assetManager.ImageAssets, "boundary_horizontal");
